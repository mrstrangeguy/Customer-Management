...
<!-- <Dropdown
header-style="py-[9px] pr-[16px] bg-[#0000000a]"
...
header-style="py-[6px] pl-[11px] pr-[10px] text-[13px] min-h-[40px]"
arrow-icon="text-[16px] text-[rgba(0, 0, 0, 0.87)] font-normal leading-[16px]"
text="Opportunities"
>
<template v-slot:dropdown-items>
  <div class="p-[11px]">
